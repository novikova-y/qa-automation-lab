...
describe('Inventory Page Tests', () => {
  ...
  describe('Error user Scenarios', () => {

  it('should display list of inventory items with name, price, and Add to cart button for error user', () => {
    cy.login('error');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it('should navigate to item detail page when clicking an item for error user', () => {
    cy.login('error');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it('should add first item to the cart and update cart badge for error user', () => {
    cy.login('error');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it.skip('should sort items by price low to high for error user', () => {
    cy.login('error');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it.skip('should sort items by price high to low for error user', () => {
    cy.login('error');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it('should sort items from A to Z for error user', () => {
    cy.login('error');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it.skip('should sort items from Z to A for error user', () => {
    cy.login('error');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it('should show error when accessing inventory after logout for error user', () => {
    cy.login('error');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  describe('Visual user Scenarios', () => {

  it('should display list of inventory items with name, price, and Add to cart button for visual user', () => {
    cy.login('visual');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it('should navigate to item detail page when clicking an item for visual user', () => {
    cy.login('visual');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it('should add first item to the cart and update cart badge for visual user', () => {
    cy.login('visual');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it.skip('should sort items by price low to high for visual user', () => {
    cy.login('visual');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it.skip('should sort items by price high to low for visual user', () => {
    cy.login('visual');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it('should sort items from A to Z for visual user', () => {
    cy.login('visual');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it('should sort items from Z to A for visual user', () => {
    cy.login('visual');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
  ...
  it('should show error when accessing inventory after logout for visual user', () => {
    cy.login('visual');
    cy.url().should('include', '/inventory.html');
    inventoryPage.inventoryContainer.should('be.visible');
    inventoryPage.itemCards.should('have.length.greaterThan', 0);
